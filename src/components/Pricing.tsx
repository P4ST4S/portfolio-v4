    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div className="bg-gradient-to-br from-white/90 via-slate-50/80 to-white/90 dark:from-slate-800/50 dark:via-slate-700/30 dark:to-slate-800/50 backdrop-blur-sm border border-slate-200/70 dark:border-slate-700/50 rounded-xl p-8 hover:border-[#00C4B3]/30 transition-all duration-300">
          ...
          <div className="bg-gradient-to-br from-[#00C4B3]/10 via-white/90 to-[#00C4B3]/5 dark:via-slate-800/50 backdrop-blur-sm border border-[#00C4B3]/50 rounded-xl p-8 relative">
            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-[#00C4B3] text-slate-900 dark:text-[#1A1A1A] px-4 py-1 rounded-full text-sm font-semibold">
        ...
        <div className="text-center mt-16 bg-gradient-to-r from-slate-100/70 via-white/80 to-slate-100/70 dark:from-slate-800/30 dark:via-slate-700/20 dark:to-slate-800/30 rounded-2xl p-8 border border-slate-200/70 dark:border-slate-700/30">
          ...
          <a
            href="#contact"
            className="inline-flex items-center bg-[#00C4B3] text-slate-900 dark:text-[#1A1A1A] font-bold py-4 px-8 rounded-lg hover:bg-[#00C4B3]/90 transition-all duration-300 transform hover:scale-105 shadow-lg"
          >
