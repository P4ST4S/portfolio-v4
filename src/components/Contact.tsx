    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-lg mx-auto">
          <h3 className="text-2xl font-bold mb-6 text-[#007E73] dark:text-[#5EEAD4] text-center">
          ...
          <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
            ...
            <input
              ...
              required
              className="w-full border border-slate-300 dark:border-slate-600 rounded px-4 py-2 placeholder:text-slate-500 dark:placeholder:text-slate-400 text-slate-900 dark:text-white bg-white/80 dark:bg-transparent"
            />
            ...
            <button
              type="submit"
              disabled={sending}
              className="w-full bg-[#007E73] text-white font-bold py-4 px-8 rounded-lg hover:bg-[#006A60] transition-all duration-300 transform hover:scale-105 text-lg disabled:opacity-70"
            >
              {sending ? (
